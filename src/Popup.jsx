...
export default function Popup({ isOpen, onClose, title, message, onCardFlip }) {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-40 z-50">
      <div className={`bg-white rounded-lg shadow-xl ${showCards ? 'w-[800px]' : 'w-[400px]'}`}>
        <div className="bg-[#013946] text-[#F0B627] px-6 py-4 rounded-t-lg">
          <h2 className="text-xl font-bold">{showCards ? "Flip a card for your daily claim!" : title}</h2>
        </div>
